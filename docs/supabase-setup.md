...
- 학습 진도(복습 단계)와 "최근 학습" 시각도 함께 동기화돼서, 한 기기에서 공부한 흐름을 다른 기기에서 이어갈 수 있습니다. 이 때문에 영상을 열거나 퀴즈를 풀 때마다 해당 영상/단어 데이터가 다시 올라갑니다(자막이 큰 영상은 데이터가 조금 클 수 있어요). 개인용 무료 한도에서는 문제없는 수준입니다.
